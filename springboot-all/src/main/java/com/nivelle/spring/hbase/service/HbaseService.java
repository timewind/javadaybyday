package com.nivelle.spring.hbase.service;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.nivelle.spring.SpringBeanUtil;
import com.nivelle.spring.hbase.annotation.Column;
import com.nivelle.spring.hbase.annotation.RowKey;
import com.nivelle.spring.hbase.generator.RowKeyGenerator;
...
import com.nivelle.spring.hbase.util.ReflectionUtils;
...
public class HbaseService implements IHbaseService {
    ...
    public <T extends Serializable> void save(final T t) {
        ...
        final com.nivelle.spring.hbase.annotation.Table table = t.getClass().getAnnotation(com.nivelle.spring.hbase.annotation.Table.class);
    ...
    private <T extends Serializable> void checkTableAnnotation(final T t, final com.nivelle.spring.hbase.annotation.Table table) {
        if (table == null) {
    ...
    public <T extends Serializable> void saveBatch(final List<T> list) {
        ...
        // 取第一个，获取表上的注解
        T first = list.get(0);
        final com.nivelle.spring.hbase.annotation.Table table = first.getClass().getAnnotation(com.nivelle.spring.hbase.annotation.Table.class);
        if (table == null) {
    ...
    public <T extends Serializable> T findOneByRowKeyValue(final T condition) {
        ...
        final com.nivelle.spring.hbase.annotation.Table table = clazz.getAnnotation(com.nivelle.spring.hbase.annotation.Table.class);
        if (table != null) {
            try {
                final String columnFamilyName = table.columnFamilyName();
                final String tableName = table.tableName();
