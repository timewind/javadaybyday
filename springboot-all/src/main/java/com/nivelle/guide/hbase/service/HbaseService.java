package com.nivelle.guide.hbase.service;
...
import com.nivelle.guide.hbase.util.ReflectionUtils;
import com.nivelle.guide.SpringBeanUtil;
...
public class HbaseService implements IHbaseService {
    ...
    public <T extends Serializable> void save(final T t) {
        ...
        final com.nivelle.guide.hbase.annotation.Table table = t.getClass().getAnnotation(com.nivelle.guide.hbase.annotation.Table.class);
    ...
    private <T extends Serializable> void checkTableAnnotation(final T t, final com.nivelle.guide.hbase.annotation.Table table) {
        if (table == null) {
    ...
    public <T extends Serializable> void saveBatch(final List<T> list) {
        ...
        // 取第一个，获取表上的注解
        T first = list.get(0);
        final com.nivelle.guide.hbase.annotation.Table table = first.getClass().getAnnotation(com.nivelle.guide.hbase.annotation.Table.class);
        if (table == null) {
    ...
    public <T extends Serializable> T findOneByRowKeyValue(final T condition) {
        ...
        final com.nivelle.guide.hbase.annotation.Table table = clazz.getAnnotation(com.nivelle.guide.hbase.annotation.Table.class);
        if (table != null) {
            try {
                final String columnFamilyName = table.columnFamilyName();
                final String tableName = table.tableName();
